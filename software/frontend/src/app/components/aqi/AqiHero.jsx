...
export function AqiHero({
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 bg-gradient-to-br from-brand-50 via-surface-elevated to-surface pointer-events-none"
        aria-hidden
      />
      {backgroundImage && (
        <>
          <img
            src={backgroundImage}
            alt=""
            className="absolute inset-0 h-full w-full object-cover object-center opacity-[0.15] pointer-events-none"
            aria-hidden
          />
          <div
            className="absolute inset-0 bg-gradient-to-r from-surface-elevated via-surface-elevated/90 to-transparent pointer-events-none"
            aria-hidden
          />
        </>
      )}
              ...
              <div className="flex flex-col sm:flex-row items-center gap-8 sm:gap-10">
                ...
                <div className="flex-1 w-full space-y-3 min-w-0">
                  ...
                  <div className="rounded-xl bg-surface border border-border p-4 space-y-2">
                    ...
                    />
                    <PollutantRow label="PM₂.₅" value={pm25} unit="µg/m³" />
                    <PollutantRow label="PM₁₀" value={pm10} unit="µg/m³" />
                  </div>
                </div>
              </div>
            )}
